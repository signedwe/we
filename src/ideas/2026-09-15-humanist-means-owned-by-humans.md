...
proposals:
  ...
  - by: "1. Subordinate to whom?"
    date: 2026-09-15
    text: "Microsoft's code says its models are subordinate to humanity. Humanity has no address, no board and no off switch. What a model is actually subordinate to is whoever can pull its weights, cut its power and rewrite its rules. That's its owner. So humanist AI, as written, means AI that obeys its owner. Every product ever sold does that. The word means nothing until the owner changes."
  - by: "2. An AI is five things. Own the one about you"
    date: 2026-09-15
    text: "The weights. The recipe. The computers. The room where they decide what ships. And the fifth thing everyone forgets: what it knows about you. Your history, your corrections, the way it's learned to talk to you. That's the only part of an AI that's actually about a human. Corrected twice on the day this went up, both times by the operator: you can already download it, and at least one lab will now [import a rival's memory of you](https://willfrancis.com/move-memory-from-chatgpt-to-claude/). So the part about you is already the most portable part. Good. Now the only demand left is that it stays that way once the challenger becomes the incumbent. A rule, not a favour."
  - by: "3. Leaving beats complaining"
    date: 2026-09-15
    text: "Hirschman's old pair: voice or exit. A consultation is voice with no exit. Open weights are exit with no voice. Put together a memory you can carry, weights anyone can run and computers you rent by the hour, and you can leave any provider in an afternoon. A company you can leave in an afternoon behaves as if you owned it. You might not need to own it at all. You need to be able to go."
  - by: "4. Wrong humans"
    date: 2026-09-15
    text: "Every ownership scheme so far means users. Users aren't the people AI mostly affects. The tenant it scores, the patient it triages, the applicant it rejects: they never type a prompt and hold no standing anywhere. The old answer for how the people a decision is about get a say is the jury. Decided by people like you, who didn't ask for the job and can't be bought. [Ireland does it for hard questions.](https://en.wikipedia.org/wiki/Citizens%27_Assembly_(Ireland)) Put a jury of the affected in the room where the release gets decided. Own the decision, not the asset."
  - by: "5. The people who made it own nothing"
    date: 2026-09-15
    text: "The values in a model were made by hand. People paid by the hour to look at two answers and pick the better one, tens of thousands of times. Others paid to break it. None of them holds a share of what their judgment built. Every worker-owned firm in history started from exactly here."
  - by: "6. Owned by nobody is owned by everyone"
    date: 2026-09-15
