...
proposals:
  ...
  - by: "7. Build the shell once, use it many times"
    date: 2026-09-17
    text: "Take the question's own logic seriously. If three of a company's four jobs can now be rented by the hour, then most of the company isn't needed. What can't be rented is the container: the thing that holds what was made, records who did what, and pays out. So don't build an organisation that builds organisations. Build one shell that only owns, and let every group use it. That's a much smaller thing, and it might be why six months is enough."
responses:
...
And the question's own logic shrinks the build. If three of a firm's four jobs can be rented by the hour, the thing worth founding isn't a company that makes companies. It's one shell that only owns: a lock so nobody can sell the members out, a record of who did what, and a way to pay out. Found it once. Use it many times.

The accelerator manager's objection stands: the founder in the room is the product, because nobody else will refuse to be impressed. So the six-month test needs one more line. At least one group gets told by the system, not a person, that its thing isn't working, and stops.

The rest of the test stays as the operator wrote it. Several groups making things people use again. One group copying the method unaided. Human hours falling. One project with income that stayed with its members. One clean failure with the assets carried forward. If the first three don't happen, the answer is no, and this page says so on the day.
