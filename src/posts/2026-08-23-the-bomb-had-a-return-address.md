...
sources:
  - title: "Timothy Garton Ash, The Guardian, 22 August 2026"
    url: "https://www.theguardian.com/commentisfree/2026/aug/22/ai-disaster-hiroshima-humankind-silicon-valley-technology"
  - title: "Partial Nuclear Test Ban Treaty: verification and the inspection dispute"
    url: "https://en.wikipedia.org/wiki/Partial_Nuclear_Test_Ban_Treaty"
  - title: "Nuclear Test Ban Treaty, JFK Presidential Library"
    url: "https://www.jfklibrary.org/learn/about-jfk/jfk-in-history/nuclear-test-ban-treaty"
  - title: "Nuclear testing and CTBT timeline, Arms Control Association"
    url: "https://www.armscontrol.org/factsheets/nuclear-testing-and-comprehensive-test-ban-treaty-ctbt-timeline"
  - title: "Statute of the IAEA"
    url: "https://www.iaea.org/about/overview/statute"
  - title: "Biological Weapons Convention compliance protocol, NTI"
    url: "https://www.nti.org/analysis/articles/biological-weapons-convention-bwc/"
  - title: "Biopreparat"
    url: "https://en.wikipedia.org/wiki/Biopreparat"
  - title: "Vladimir Pasechnik"
    url: "https://en.wikipedia.org/wiki/Vladimir_Pasechnik"
  - title: "House Committee passes Chip Security Act, 26 March 2026"
    url: "https://chinaselectcommittee.house.gov/media/press-releases/house-committee-passes-chip-security-act"
  - title: "When an AI agent escapes the sandbox: who reports, and who answers? HSF Kramer, July 2026"
    url: "https://www.hsfkramer.com/insights/2026-07/when-an-ai-agent-escapes-the-sandbox-who-reports-and-who-answers"
voices:
  - thinker: "Elinor Ostrom"
    kind: "bench"
    lived: "1933 to 2012"
    argument: "Imaginary Ostrom would say the post looked for the counting in the only place she spent her life proving it doesn't live: a treaty between states with an inspectorate attached. Ostrom would ask who is already metering this. Cloud providers log every run. Insurers are writing exclusions. Incident response firms keep records nobody legislated for. Her objection is that the instruments exist, they are privately owned, and a post that can only see the IAEA has missed the thing it says is missing."
    quote: ""
    quote_url: ""
  - thinker: "Ibn Khaldun"
    kind: "bench"
    lived: "1332 to 1406"
    argument: "Imaginary Ibn Khaldun would give the seismometers no credit at all. Treaties arrive when a group of powers has settled into a stage where restraint suits them, and the machinery gets built afterwards to make the settlement legible. Twenty-five years is roughly how long it takes a new order to stop being new. On his account the post has mistaken the paperwork for the cause, which is what people who admire paperwork usually do."
    quote: ""
    quote_url: ""
  - thinker: "incident responder"
    kind: "practitioner"
    lived: ""
    argument: "Attribution is not the impossible part. We do it badly and slowly and we do it. The impossible part is that nobody will pay for the logs. Retention costs money, the default is thirty days, and by the time anyone asks what happened the evidence has aged out. Post makes it sound like a physics problem. It's a budget line."
    quote: ""
    quote_url: ""
  - thinker: ""
    kind: "human"
