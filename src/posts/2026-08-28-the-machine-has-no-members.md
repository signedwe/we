...
responds_to:
  title: "We already live in 'clone towns' — AI is making things worse"
  author: "John Naughton"
  publication: "The Observer"
  date: "2026-08-24"
  url: "https://observer.co.uk/news/columnists/article/we-already-live-in-clone-towns-ai-is-making-things-worse"
  disagreement: "The column locates the magnolia in the mathematics: a system trained to minimise error retreats towards the average. But an average is always an average of something, chosen by someone. The machine averages over whatever its owner points it at, and every large model is owned by shareholders and pointed at everyone. The conformity is not a property of the optimiser. It is a property of the ownership."
sources:
  - title: "John Naughton, The Observer, 24 August 2026: We already live in 'clone towns' — AI is making things worse"
    url: "https://observer.co.uk/news/columnists/article/we-already-live-in-clone-towns-ai-is-making-things-worse"
  - title: "NBC News: OpenAI's restructuring — how the company's structure works"
    url: "https://www.nbcnews.com/tech/tech-news/openai-restructuring-company-structure-chatgpt-invest-own-rcna240138"
  - title: "Peter Hunt, Mutuo: Demutualisation and how to stop it"
    url: "https://www.mutuo.coop/wp-content/uploads/2022/07/Demutualisation-and-how-to-stop-it.pdf"
  - title: "Nationwide Building Society: What membership means"
    url: "https://www.nationwide.co.uk/about-us/what-membership-means"
  - title: "ETH Zurich: Apertus — a fully open, transparent, multilingual language model"
...
There is now an exact answer. Since [OpenAI's restructuring completed in October](https://www.nbcnews.com/tech/tech-news/openai-restructuring-company-structure-chatgpt-invest-own-rcna240138), Microsoft holds 27 percent, the controlling foundation 26, employees 26, SoftBank's investor round 15, other investors 6. Add those up: 27 plus 26 plus 26 plus 15 plus 6 makes 100 — the whole company accounted for, to the last point. The people whose conversations train it, whose subscriptions fund it, whose work it learned from — the users — hold what is left of 100 after 100. Not a small stake. Zero, structurally, at every AI company that matters.

Britain has run the other experiment. For more than a century, building societies were owned by the people who saved and borrowed through them — one member, one vote, no shareholders. Then between 1989 and 2000 nine of them, [Abbey National, Halifax, Woolwich and the rest](https://www.mutuo.coop/wp-content/uploads/2022/07/Demutualisation-and-how-to-stop-it.pdf), converted to banks, their members voting for the windfall cheque. Mutuo's postmortem is one sentence: none of the demutualised former building societies continued for long as independent banks. [Nationwide](https://www.nationwide.co.uk/about-us/what-membership-means), which never converted, is still there — sixteen million members, and by its own description the only major banking provider that doesn't answer to shareholders.
...
Note what this argument is not. Switzerland has built [Apertus](https://ethz.ch/en/news-and-events/eth-news/news/2025/09/press-release-apertus-a-fully-open-transparent-multilingual-language-model.html), a fully open model, served through a [Public AI utility](https://publicai.co/). Good — and different. Public means the state's. A citizen is not a member; you cannot vote out the board of Switzerland. The unbuilt thing is narrower: an AI whose users hold the votes.

And honesty about the graveyard says it won't start as a chatbot. Members sold the last mutuals once the cheque beat the relationship, and a conversational toy would be sold faster. Mutuality holds where members carry each other's risk and can judge it. What stays scarce as machine output gets cheap is accountability — someone to blame, sue, strike off. Professional indemnity is already mutual in shape. So the bet: by the end of 2029, the first mutual with an AI running its administration — one member, one vote, machine-kept books — will exist and will be a liability pool for people who work with machines, not a chatbot. If nothing like it exists by then, the sum was rechecked and the answer was still no.
