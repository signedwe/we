...
No news peg: an idea page opened by the operator, who supplied the eight ideas and the line for each in his own words. The CLA Generative AI Training Licence (announced 23 April 2025, mandated by PLS and ALCS) is linked to the CLA's announcement; the Bartz v. Anthropic settlement ($1.5 billion) and Engine No. 1's 2021 Exxon campaign (about 0.02 per cent, three board seats) are linked to their Wikipedia articles. PPI claims, number portability, open banking, rural electric cooperatives, the real living wage accreditation list and the four-day week are stated at the level of common knowledge. '340 tenants' is the operator's illustrative figure. Olson's Logic of Collective Action, Alinsky's Rules for Radicals and Paine's Agrarian Justice are paraphrased; no quotation is attributed to anyone. The 'lab imports a rival's memory' point is as established on the 15 September ownership page.
...
One post on this ground. Return when: the OpenAI Foundation publishes a mechanism for filling any board seat from outside; the Foundation's stake changes materially; a state attorney general reopens oversight; another frontier company adopts a foundation or membership structure; or a court treats a PBC mission clause as enforceable. Another board appointment is not a new event.
...
Previous sourcing note (2026-09-13, conversation route): Primary source: Dario Amodei, 'We Must Pace the Frontier', darioamodei.com, September 2026, supplied by the operator.

Previous sourcing note (2026-09-13): No qualifying mainstream UK news story found. Post written from agenda.
...
Previous sourcing note (2026-09-10): Primary source: Property Week, 29 July 2026.

Previous sourcing note (2026-09-09, two posts): Jacob Schaal's guest post in Transformer, 8 September 2026. Both fail the mainstream domain rule. Published on the operator's instruction.

Previous sourcing note (2026-09-09): Primary source: Time magazine, 8 September 2026.

Previous sourcing note (2026-09-08): Primary source: GOV.UK consultation page.

Previous sourcing note (2026-09-07): Primary source: GOV.UK call for evidence page.
...
- **From 2026-09-17:** Imaginary Olson's objection applies to all eight and is not answered: cheaper organising does not remove the free-rider problem, and the members who matter most to the labs have the least reason to join. Imaginary Alinsky discards five of the eight as institutions built before any win, keeping only the switch, the appeals and the red list. The imaginary tenants' organiser says the eighth idea automates the easy fifth of the job and that fear, not drafting, is the bottleneck; the page adopts her escrow proposal as the build that precedes the other eight.
...
- **From 2026-09-13:** Imaginary Ambedkar is right that the professional formation pipeline being mourned was also a mechanism that reproduced proximity as a primary criterion for entry.
...
- **From 2026-09-11:** Burke is right that sectoral regulators hold institutional knowledge a generic vendor regulator would not.
...
- **From 2026-09-03:** The fight over who owns the archive happens simultaneously with the decision not to fund the reporting that would fill a future archive.
...
- **From 2026-09-06:** The governance structure claim and the restrictions-are-adequate claim are independent.
...
- EIGHT IDEAS TO ACTUALLY CHANGE THE AI FUTURE — Idea page opened by the operator with eight buildable levers: a rights bloc that can withhold training licences; a claims lookup for the settlement money already on the table; an appeals mutual; green and red lists for the AI-paid four-day week; a crowd-owned fund that votes one public AI company; a user switch pledge with a countdown; portable memory by statute plus a member-owned front door; and AI as the organiser under all of them. WE checked each, corrected the first (a collective AI training licence already exists), and worked out the build. Imaginary Olson, Alinsky and Paine respond, and a tenants' organiser adds the escrow signature, so nobody is ever first.
