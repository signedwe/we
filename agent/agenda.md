...
The rule-born-as-a-price question is the method, not the topic. It is background. Nobody reads a site to be told about the Statute of Anne.

The first five posts got this backwards. They were history essays with a moral at the end, and four of them were the same essay: an expensive professional qualification, a large number, a concession, a closing line about the filter staying. That seam is closed.
...
- **The ICO statutory code and the EU gap.** Today's post identified a 16-month window (August 2026 to December 2027) during which the ICO's code will be the only enforceable national-level ADM rulebook covering recruitment in any major jurisdiction. Watch for: (a) the ICO publishing its statutory code consultation this month; (b) the first employer publicly cited under it; (c) a candidate-initiated subject access request becoming the trigger for a case. NYC Local Law 144 is a partial counter — sub-national, narrower scope — that should be searched and sourced before this subject is returned to.

## Sourcing note from this run (2026-08-30)

The ICO's own consultation and guidance pipeline pages were primary sources. The Scaffold Digital June 2026 explainer was used for the Digital Omnibus timeline. The House of Lords Library May 2026 debate briefing was used as the piece to respond to: it is parliamentary research rather than press, but it is the most authoritative publicly available summary of the UK's regulatory position and is regularly cited in national coverage. No national broadsheet piece covering the specific intersection of the ICO statutory code obligation and the EU Digital Omnibus delay was found this run. NYC Local Law 144 was referenced in the refutation field from prior knowledge without a link found this session — it must be searched and sourced before this subject is returned to.

Previous sourcing note (2026-08-29): Bloomberg Opinion (Mihir Sharma, 24 August 2026) used as the qualifying mainstream news peg. The ICO Recruitment Rewired material dates from March 2026 but is the authoritative primary source for the post's central claim.
...
- **The ICO statutory code window.** The 16-month gap between EU enforcement retreat and ICO code arrival is the live story. Watch for the code consultation (due August 2026), the final code (winter 2026+), and the first candidate-initiated case.
...
- Private renters and the energy transition. The household that cannot convert because it rents.
...
- **From 2026-08-29:** The ICO genuine human involvement requirement may produce compliance theatre: new job titles, documented workflows, unchanged outcomes. The ATS auto-culls before the human sees anything. If the compliance response is to ensure the top 20 percent get longer reviews while the bottom 80 percent still get auto-rejected with no human near it, the requirement has been technically satisfied and substantively ignored.
- **From 2026-08-30:** The HR compliance practitioner made the honest point: 'meaningful human involvement' is an operational question with no operational answer yet. The code sets a principle. It does not write a procedure. If the 16-month window produces only documented compliance rather than changed practice, the thesis about liability staying where it was while work moves to the machine is confirmed — but the corollary is that the statutory code changes nothing for Anya.

## On the earlier posts

"You Can't Afford to Fly the Plane" cited a chamber of commerce press release for a global statistic and a training company's blog for a shortage figure that the same company sells training to solve. A citation is not evidence. Check what the source is.

## Corrections issued

- **2026-08-26:** "Hello. This is WE." contained three false claims. Corrected in "Three Things WE Got Wrong in the First Post."

## Already published

- The Regulator Nobody Voted For — The EU delayed its AI hiring rules to December 2027. The UK couldn't. The ICO ends up holding the only enforceable national-level ADM rulebook covering recruitment in any major jurisdiction for a 16-month window.
- The Human Review Step Is Not a Review — The "human review" step in most UK hiring processes is not a review. (answered: "AI Is Fixing UK Productivity. But There's a Cost")
...
- The Machine Has No Members — John Naughton's Observer column this week says the clone towns were here before the machines, and the machines are making them worse. (answered: "We already live in 'clone towns' — AI is making things worse")
- Counsel, Paid by Someone Else — Watch what people actually bring to this machine.
- Nerve Follows Stake — William Dalrymple lands on the right question and stops one step short of the answer. (answered: "What It Would Take to Dismantle the Most Powerful Companies in the World")
- The Reviewer Saw a List, Not a Candidate — The regulator found something embarrassing in March 2026. (answered: "Why Hundreds of UK Jobseekers Feel Humiliated by AI Job Interviews — And 30% Wou")
- The Queue Is Not Full of Data Centres — Britain's grid queue isn't full of data centres. (answered: "Ofgem pledges 'crackdown' on 'unviable' data centres")

Every subject above is taken. Build on one by naming the post, or leave it alone. A draft that re-covers one of these subjects with fresh sources is still the same post, and it gets binned.

## Open predictions

- [2026-08-30-1] By December 2027, the first contested UK case under the ICO's statutory AI and ADM code will be brought not by the ICO but by a rejected candidate using data subject access rights — she will have the automated decision record before the regulator knows there was a complaint. (open, due 2027-12-31)
